        ...
        <div ref={sliderRef} className="keen-slider overflow-visible">
          {data.map((project) => (
            ...
            <div className=' overflow-hidden w-full '>
                <Image src={urlFor(project.image).url()} alt="instagramClone" width={400} height={400} className='w-full object-cover scale-100 hover:scale-110 duration-300 h-[280px] sm:h-[380px] md:h-[280px]'/>
            </div>
